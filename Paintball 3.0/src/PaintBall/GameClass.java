...
public class GameClass implements Game {
    ...
    public void initGame(int width, int height, int teamsNr, int bunkersNr){
        ...
        bunkers = new ArrayClass<Bunker>(bunkersNr);
        teams = new ArrayClass<Team>(teamsNr);
        fillMap();
    }
    ...
    public void addTeam(String teamName, String bunkerName) {
        ...
        conquerBunker(team, bunkerName);
        
    }
    
    private void conquerBunker(Team team, String bunkerName) {
    	bunkers.get(findBunkerIdx(bunkerName)).changeTeam(team);
    }

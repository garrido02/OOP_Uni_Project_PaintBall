...
public interface Game {
    ...
    public static boolean attackingPlayerWins(Player player, Player other) {
    	boolean result = true;;
    	if(player instanceof RedPlayerClass && other instanceof GreenPlayerClass) {
    		result = false;
    	}else if(player instanceof GreenPlayerClass && other instanceof BluePlayerClass) {
    		result = false;
    	}else if(player instanceof BluePlayerClass && other instanceof RedPlayerClass) {
    		result = false;
    	}
    	return result;
    }

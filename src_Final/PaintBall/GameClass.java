...
public class GameClass implements Game {
    ...
    public boolean attack() {
        ...
        while (playersIte.hasNext() && !isGameOver()){
            ...
            while (coordsIte.hasNext() && !isGameOver()){
                ...
                if(!m.getTeam().isActive()){
                    teams.removeAt(teams.searchIndexOf(m.getTeam()));
                } else if (!p.getTeam().isActive()){
                    teams.removeAt(teams.searchIndexOf(p.getTeam()));
                    result = false;
                }
            }
        }
...
//			return true;
//		else if(!(player instanceof RedPlayerClass) && nrMoves < RedPlayerClass.MAX_MOVES)
//			return true;
//		else 
